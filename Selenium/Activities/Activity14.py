...
with webdriver.Chrome() as driver:
    ...
    # Get the cell values of the footer
    footer_cells=driver.find_elements(By.XPATH,"//table[@id='sortableTable']/tfoot/tr/th")
    # Print the cell value
    for cell in footer_cells:
        print("Cell values of the footer: ",cell.text)
    driver.quit