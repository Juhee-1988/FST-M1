...
with webdriver.Chrome() as driver:
    ...
    actions.send_keys("J") # Press the key of your first names initial
    ...
    # actions.send_keys("J").key_down(Keys.CONTROL).send_keys("a").send_keys("c").key_up(Keys.CONTROL).perform()