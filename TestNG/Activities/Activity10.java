...
public class Activity10 {
    ...
    public void registrationTest(List<Object> rows) {
        ...
        // Enter the data
        firstNameField.sendKeys(rows.get(0).toString());
        lastNameField.sendKeys(rows.get(1).toString());
        emailField.sendKeys(rows.get(2).toString());
        phoneNumberField.sendKeys(rows.get(3).toString());
